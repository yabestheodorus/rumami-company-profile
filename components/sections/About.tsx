...
import { aboutPaths } from '@/components/constants/svgPaths'
    ...
    const ctx = gsap.context(() => {
      ...
      if (designsRef.current) {
        const paths = Array.from(
          designsRef.current.querySelectorAll<SVGPathElement>('path'),
        )
      ...
      <section className="relative w-full min-h-screen bg-background flex flex-col items-center justify-center px-6 py-32">
        ...
        <div className="relative">
          ...
          <svg
            ...
            strokeMiterlimit={1}
            className="text-textAccent absolute -bottom-12 lg:-bottom-20 left-1/2 -translate-x-1/2 w-[clamp(12rem,26vw,24rem)] pointer-events-none"
          >
        ...
        <p className="font-sans text-dark text-center text-lg max-w-lg mt-32 leading-relaxed">
          Rumami menghadirkan layanan desain interior custom secara menyeluruh — mulai dari konsep awal dan konsultasi estetika hingga koordinasi, eksekusi, serta sentuhan akhir yang menawan.
        </p>
        ...
        <nav className="font-sans text-textAccent uppercase tracking-[0.25em] text-sm flex gap-12 mt-20">
          ...
          <a href="/works" className="flex items-center gap-2">
            <span aria-hidden>&raquo;</span> Karya
          </a>
        </nav>
      </section>

    ...
    <section className="relative w-full min-h-[90vh] bg-background flex flex-col items-center justify-center px-6 pt-40 pb-32">
      ...
      <div className="relative">
        ...
        <svg
          ...
          strokeMiterlimit={1}
          className="draw-designs text-textAccent absolute -bottom-20 left-1/2 -translate-x-1/2 w-[clamp(12rem,26vw,24rem)] pointer-events-none -translate-y-8 md:-translate-y-0"
        >
      ...
      <p className="font-sans text-dark text-center text-lg max-w-lg mt-32 leading-relaxed">
        Galeri pilihan interior custom, furniture, dan detail finishing — diabadikan melalui foto dan video. Setiap bingkai adalah wujud dari apa yang Rumami desain, bangun, dan hasilkan.
      </p>
    </section>
  )
}
